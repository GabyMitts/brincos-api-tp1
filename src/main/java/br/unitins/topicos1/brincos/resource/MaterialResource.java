...
public class MaterialResource {
    ...
    @GET
    public List<MaterialDTOResponse> buscarTodos(@DefaultValue("0") @QueryParam("page") int page,
    ...
    @GET
    @Path("/{id}")
    public MaterialDTOResponse buscarPorId(Long id) {
    ...
    @POST
    @RolesAllowed("Admin")
    public MaterialDTOResponse incluir(MaterialDTO dto) {
