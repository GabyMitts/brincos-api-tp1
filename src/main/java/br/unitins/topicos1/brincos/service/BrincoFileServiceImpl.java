...
import br.unitins.topicos1.brincos.repository.ArquivoRepository;
...
@ApplicationScoped
public class BrincoFileServiceImpl implements FileService {
    private static final Set<String> ALLOWED_EXTENSIONS = Set.of("jpg", "jpeg", "png", "gif", "webp");
    private static final long MAX_FILE_SIZE = 5L * 1024 * 1024;
    private static final long MIN_FILE_SIZE = 1L * 1024;

    @Inject
    BrincoRepository brincoRepository;
    ...
    public void salvar(Long id, FileUpload file) throws IOException {
        Brinco brinco = brincoRepository.findById(id);
        if (brinco == null) {
            throw new NotFoundException("Brinco não encontrado.");
        }
    ...
    public void remover(String fid) {
        ...
        brincoRepository.findByArquivoId(arquivo.getId()).ifPresent(brinco -> brinco.removeArquivo(arquivo));
